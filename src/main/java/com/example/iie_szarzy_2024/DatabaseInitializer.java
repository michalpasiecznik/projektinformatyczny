    ...
    public static void main(String[] args) {
        try {
            ...
            String[] sqlQueries = {
                    ...
                    // Zadania
                    "CREATE TABLE `zadania` (`IDZadania` int(4) NOT NULL AUTO_INCREMENT, `Opis` varchar(100) NOT NULL, `Status` varchar(50) NOT NULL, `DataUtworzenia` datetime NOT NULL, `DataRozpoczecia` datetime NOT NULL, `DataZakonczenia` datetime NOT NULL, `IDKierownika` int(4) NOT NULL, PRIMARY KEY (`IDZadania`), FOREIGN KEY (`IDKierownika`) REFERENCES `kierownicy`(`IDKierownika`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;",
                    "INSERT INTO `zadania` (`Opis`, `Status`, `DataUtworzenia`, `DataRozpoczecia`, `DataZakonczenia`, `IDKierownika`) VALUES ('Ułożenie towaru na półkach', 'W toku', '2024-05-01 08:00:00', '2024-04-10 10:00:00', '2024-04-15 14:30:00', 1), ('Przyjęcie zaopatrzenia sklepu', 'Zakończone', '2024-04-20 12:00:00', '2024-04-05 09:00:00', '2024-04-18 16:45:00', 1), ('Policzenie utargu', 'Oczekujące', '2024-06-01 08:00:00', '2024-03-20 11:30:00', '2024-03-25 15:20:00', 2), ('Rozliczenie podatkowe', 'W toku', '2024-04-30 17:00:00', '2024-02-15 08:00:00', '2024-04-10 12:10:00', 2);",
